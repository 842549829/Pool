...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Linq.PartialEvaluator.cs
// description：
// 
...
namespace Izual.Linq {
    ...
    public static class PartialEvaluator {
        ...
        private class SubtreeEvaluator : ExpressionVisitor {
            ...
            private Expression UnOperand(Expression exp) {
                if (exp == null)
                    return null;
            ...
            private Expression GetInstance(MemberExpression exp) {
                Expression result = exp.Expression;
            ...
            private Expression Evaluate(Expression e) {
                ...
                if(me != null) {
                    ...
                    // TODO:let the Nullable<?>.Value can be Specified,when it's null.
                    //if(TypeHelper.IsNullableType(me.Type)) {
                    //    var instance = GetInstance(me);
                    //    if(instance.NodeType == ExpressionType.Constant) {
                    //        if(((ConstantExpression)instance).Value == null) {
                    //            return PostEval(Expression.Constant(null, type));
                    //        }
                    //    }
                    //}
