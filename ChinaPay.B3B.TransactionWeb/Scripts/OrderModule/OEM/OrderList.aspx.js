function bindData(data) {
    ...
    $.each(data.Orders, function (index, item) {
        ...
        html.push("' class='obvious-a'>详情</a><br /><a href='../OrderLog.aspx?id=" + item.OrderId);
        html.push("' class='obvious-a'>日志</a>" );
...
function queryOrders(pageIndex, pageSize) {
    ...
    var parameters = JSON.stringify({ "pagination": pagination, "orderQueryCondition": condition, oem: oemId });
    ...
    sendPostRequest("/OrderHandlers/Order.ashx/QueryOEMOrderList", parameters, function (data) {
        bindData(data);
    }, function (e) {
