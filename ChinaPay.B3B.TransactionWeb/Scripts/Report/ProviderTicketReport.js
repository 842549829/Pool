$(function () {
    ...
    $("#btnDownload").click(function () {
        ...
        var takeOffStartDate = $.trim($("#txtTakeOffLower").val());
        var takeOffEndDate = $.trim($("#txtTakeOffUpper").val());
        ...
        var providerTicketCondition = startDate + ',' + endDate + ',' + payStartDate + ',' + payEndDate + ','
                                             + ticketNo + ',' + passenger + ',' + departure + ',' + arrival + ',' + titcketStatus + ',' + policyType + ','
                                              + airlines + ',' + tiketType + ',' + orderId + ',' + companyId + ',' + officeNo + ',' + relationType + ',' + purchase + ',' + processorAccount + ',' + speacialType+','+takeOffStartDate+','+takeOffEndDate;
        window.open('ReportDownload.aspx?providerTicketCondition=' + providerTicketCondition, 'newwindow');
    });
