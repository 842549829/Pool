$(function () {
    ...
    $("#btnDownload").click(function () {
        if (valiate()) {
            ...
            var purchaseFinancialCondition = startDate + ',' + endDate + ',' + payStartDate + ',' + payEndDate + ',' + takeOffStartDate + ',' + takeOffEndDate + ','
                                             + ticketNo + ',' + passenger + ',' + pnr + ',' + departure + ',' + arrival + ',' + titcketStatus + ',' + policyType + ','
                                              + airlines + ',' + tiketType + ',' + companyId + ',' + orderId+','+payType;
            window.open('ReportDownload.aspx?purchaseFinancialCondition=' + purchaseFinancialCondition, 'newWindow');
        }
    });
