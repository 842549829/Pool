    ...
    $.fn.tipTip = function (options) {
        ...
        return this.each(function () {
            ...
            if (opts.content) {
                ...
                var text = $.trim(org_elem.text());
                if (text.length > opts.limitLength) {
                    org_title = $.trim(org_elem.html());
                    org_elem.html(text.substring(0, opts.limitLength) + "...");
                } else {
                    org_title = "";
                }
            ...
            if (org_title && org_title != "") {
                ...
                function active_tiptip() {
                    ...
                    if (org_title != "") tiptip_content.html(org_title);
