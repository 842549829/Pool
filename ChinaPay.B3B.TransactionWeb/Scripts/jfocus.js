(function ($) {
    jQuery.fn.jFocus = function (o) {
        o = jQuery.extend({
            ...
            event: "mouseover", //绑定触发切换的事件，比如设置为mouseover
        ...
        return this.each(function () {
            ...
            var opt = "<span class='index'>" + index.join(" ") + "</span>";
            var $jfocus = $(".jfocus", $this);
            ...
            $num.bind(o.event, function () {
                ...
                toggle($meta, index); //两次切换。。。为了万恶的IE
                $(this).blur();
                return false;
            });
