<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlightQueryGoResult.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.FlightReserveModule.FlightQueryGoResult" %>
...
<body>
    ...
    <div class="flow">
        ...
        <div class="clearfix" id="flightHeader">
				<h4>选择去程航班: <span class="departureName num"></span> → <span class="arrivalName num"></span>(<span id="pickDate"></span>)
				<p>共<span id="flightsCount" class="num"></span>个航班信息</p></h4>
				<div class="corner">
                <div class="step">
                    <div class="line-bg"></div>
                    <i class="active">●<span>1</span></i>
                    <i style="left: 48%;">●<span>2</span></i>
        ...
        <%-- 航班结果信息 --%>
        <div class="column">
            <div class="order-info"><div class="hd" id="divDateTitle"></div></div>
            <div id="divError"></div>
...
<script type="text/javascript" language="javascript">
    $(function () {
        ...
        queryFlights("21", $("#hidFlightValidyMinutes").val(), "divSearching", "divContent", "divDateTitle", "FlightList", "divError");
