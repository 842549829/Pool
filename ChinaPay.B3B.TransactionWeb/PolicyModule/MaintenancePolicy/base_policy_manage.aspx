<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="base_policy_manage.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.base_policy_manage" %>
...
<head runat="server">
    <title>运营普通政策管理</title>
    <script src="/Scripts/jquery-1.7.2.min.js" type="text/javascript"></script>
    <script src="/Scripts/UserControl/company.ascx.js" type="text/javascript"></script>
</head>
                    ...
                    <tr>
                        <td>
                            <div class="input">
                                ...
                                <%--<uc1:Company_1 ID="AgentCompany" runat="server" />--%>
                                <uc1:Company_2 ID="AgentCompany" runat="server" />
                            </div>
                        </td>
                        <td>
                            <div class="input">
                                <span class="name">下级返佣：</span>
    ...
    <div id="data-list" class="table">
        <asp:GridView ID="grv_normal" runat="server" CssClass="nfo-table info" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="供应方">
                    <ItemTemplate>
                        <%#Eval("Opearor")%>
                    </ItemTemplate>
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href='base_policy_info.aspx?id=<%#Eval("id") %>'>查看</a><br />
                        <%#Eval("LockTip")%><br />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
