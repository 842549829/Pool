<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="team_policy_info.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.team_policy_info" %>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            $("#lblDeparture,#lblArrival,#lblTransit,#lblDepartureFilght,#lblRetnrnFilght,#lblExceptAirlines").tipTip({ maxWidth: "400px", limitLength: 60 });
        });
    </script>
</body>
</html>
