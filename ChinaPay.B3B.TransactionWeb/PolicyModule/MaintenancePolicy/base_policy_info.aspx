<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="base_policy_info.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.base_policy_info" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>运营查看普通政策信息</title>
...
<body>
    ...
    <div style="text-align: center;">
        ...
        <asp:Button ID="btnTiedian" CssClass="btn class1" Visible="false" runat="server"
            Text="设置贴扣点" OnClick="btnTiedian_Click" />
        <asp:Button ID="btnLog" CssClass="btn class1" runat="server" Text="查看日志" OnClick="btnLog_Click" />
        <input type="button" id="btnBack" class="btn class2" value="返回" onclick="javascript:window.location.href='base_policy_manage.aspx'" />
    </div>
