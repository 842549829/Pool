<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notch_policy_manage.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.notch_policy_manage" %>
        ...
        <asp:GridView ID="grv_normal" runat="server" CssClass="nfo-table info" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href='notch_policy_info.aspx?id=<%#Eval("id") %>'>查看</a><br />
                        <%#Eval("LockTip")%><br />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
