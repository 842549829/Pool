<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="low_price_policy_info.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.low_price_policy_info" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>运营特价政策查看</title>
...
<body>
    ...
    <div style="text-align: center;">
        ...
        <input type="button" id="btnBack" class="btn class2" value="返回" onclick="javascript:window.location.href='low_price_policy_manage.aspx'" />
    </div>
