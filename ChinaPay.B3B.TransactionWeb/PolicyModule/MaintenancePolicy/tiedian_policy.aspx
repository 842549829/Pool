<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="tiedian_policy.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.MaintenancePolicy.tiedian_policy" %>
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <div class="obvious1">
                        贴点航线请按照出发城市达到城市的三字码格式输入，多个请用/隔开，如KMGCTU/SHAPEK、支持*号通配符，如KMG*表示KMG出港到该政策内航线均进行贴点</div>
                </td>
            </tr>
            <tr>
                <td class="title">
            ...
            <tr>
                ...
                <td colspan="3">
                    ...
                    <span class="obvious1">请注意，按照你输入的贴点值，采购所见到的返点将是该政策发布的同行返点加上你的贴点值总和 </span>
                </td>
            </tr>
            <tr>
                <td class="title">
                ...
                <td colspan="3">
                    ...
                    <span class="obvious1 fl">贴点日期到期后将不再执行贴点，请注意，贴点截止日期不能大于航班日期。 </span>
                </td>
            </tr>
            <tr>
                <td class="title">
        ...
        <div id="data-list" class="table">
            ...
            <asp:GridView ID="grvTiedian" runat="server" CssClass="nfo-table info" Width="100%"
                ...
                <Columns>
                    ...
                    <asp:BoundField HeaderText="贴点值" DataField="Commission" />
                    <asp:TemplateField HeaderText="贴点期限">
                        <ItemTemplate>
                           <%#Eval("StartTime")%> 至 
                           <%#Eval("EndTime")%>
                        </ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="操作">
                        <ItemTemplate>
                            <asp:LinkButton CommandArgument='<%#Eval("Id") +"|"+ Eval("Enable") %>' CommandName="disEnable"
                                runat="server">
                           <%#Convert.ToBoolean(Eval("Enable")) ? "禁用" : "启用" %>
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--<asp:BoundField HeaderText="操作" DataField="Creator" />--%>
                </Columns>
            </asp:GridView>
        </div>
    </div>
