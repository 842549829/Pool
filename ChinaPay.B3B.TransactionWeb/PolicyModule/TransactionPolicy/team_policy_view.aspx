<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="team_policy_view.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.TransactionPolicy.team_policy_view" %>
...
<body>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $(".DepartureDateFilter").tipTip({ limitLength: 17, maxWidth: "300px" });
