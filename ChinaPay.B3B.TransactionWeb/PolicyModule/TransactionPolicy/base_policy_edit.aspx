<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="base_policy_edit.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.PolicyModule.TransactionPolicy.base_policy_edit" %>
...
<body>
    ...
    <h3 class="titleBg">
        <span id="tip" runat="server">普通政策修改</span> —— <span id="titlePolicy" runat="server">
            单程</span></h3>
    <div class="form">
        <table>
            <colgroup>
    ...
    <script src="/Scripts/PolicyModule/policy_base_edit_vaildate.js?20130416" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#txtDepartrueStart").focus(function () {
                WdatePicker({ isShowClear: false, skin: 'default', readOnly: "true", onpicked: function () { $("#Bunks").html("<label class='refBtnBunks btn class3'>点击获取舱位</label>"); $("#hidBunks").val(""); }, doubleCalendar: "true", maxDate: '#F{$dp.$D(\'txtDepartrueEnd\')||\'2020-10-01\'}' });
            });
            $("#txtDepartrueEnd").focus(function () {
                WdatePicker({ isShowClear: false, skin: 'default', readOnly: "true", onpicked: function () { $("#Bunks").html("<label class='refBtnBunks btn class3'>点击获取舱位</label>"); $("#hidBunks").val(""); }, doubleCalendar: "true", minDate: '#F{$dp.$D(\'txtDepartrueStart\')}', maxDate: '2020-10-01' });
            });
            $("#txtProvideDate").focus(function () {
                WdatePicker({ isShowClear: false, skin: 'default', readOnly: "true", minDate: '1900-10-01', onpicked: function () { $("#Bunks").html("<label class='refBtnBunks btn class3'>点击获取舱位</label>"); $("#hidBunks").val(""); }, doubleCalendar: "true", maxDate: '#F{$dp.$D(\'txtDepartrueStart\')}' });
            });
        ...
        function GetBunks() {
            ...
            //查询舱位
            var param = { "airline": airline, "startTime": $("#txtDepartrueStart").val(), "endTime": $("#txtDepartrueEnd").val(), "startETDZDate": $("#txtProvideDate").val(), "voyage": voyage, "isOneWay": isOneWay };
