<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommodityExChangeList.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.IntegralCommodity.CommodityExChangeList" %>
    ...
    <div id="data-list" class="table column">
        <asp:GridView ID="grv_xiaofei" runat="server" AutoGenerateColumns="false" EnableViewState="false">
            <Columns>
                ...
                <asp:BoundField DataField="OEMName" HeaderText="申请来源" />
