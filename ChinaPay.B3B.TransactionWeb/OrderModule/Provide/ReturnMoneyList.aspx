<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReturnMoneyList.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.OrderModule.Provide.ReturnMoneyList" %>
...
<div class="table" id='data-list' >
    ...
    <HeaderTemplate>
        ...
        <ItemTemplate>
			 <tr>
                    <td><a href='<%#(ApplyformType)Eval("ApplyformType")==ApplyformType.Postpone?"PostponeApplyformDetail.aspx":"RefundApplyformDetail.aspx" %>?id=<%# Eval("ApplyformId") %>' class="obvious-a"><%# Eval("ApplyformId")%></a></td>
				...
				<td><a href='ProcessReturnMoney.aspx?id=<%# Eval("ApplyformId") %>' class="obvious">退款</a></td>
			</tr>
        </ItemTemplate>
        <FooterTemplate>
            		</tbody>
