<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeProcessList.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.OrderModule.Agent.ChangeProcessList" EnableViewState="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <meta charset="UTF-8">
    <title>退票处理【出票方】</title>
</head>
...
<body>
    ...
    <div class="orderBox">
        <div class="orderCondition clearfix">
            ...
            <span>PNR：
                <asp:TextBox runat="server" ID="txtPNR" class="text  text-s"></asp:TextBox></span> <span>申请单号：<asp:TextBox
                    ID="txtApplyformId" class="text" runat="server" /></span>
...
<script src="/Scripts/OrderModule/ProviderProcessQueryApplyform.js?20130412" type="text/javascript"></script>