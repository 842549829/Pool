<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeList.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.OrderModule.Operate.ChangeList" EnableViewState="False" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>改期处理【运营商】</title>
...
<body>
    ...
    <div class="orderBox">
        <div class="orderCondition clearfix">
           <span>申请日期：
                <asp:TextBox ID="txtAppliedDateStart" class="text text-s" runat="server" onfocus="WdatePicker({isShowClear:false,readOnly:true,maxDate:'#F{$dp.$D(\'txtAppliedDateEnd\')}'})" />
        ...
        <ul class="orderSubnav clearfix" id="posponeStauts" runat="server">
          ...
          <li><a href='javascript:void(0)'>等待处理</a></li>
          <li><a href='javascript:void(0)'>已支付待改期</a></li>
        </ul>
    </div>
...
<script type="text/javascript" src="/Scripts/widget/common.js?20130301"></script>
<script src="/Scripts/Global.js?20130301" type="text/javascript"></script>
<script src="/Scripts/OrderModule/QueryList.js?20130301" type="text/javascript"></script>
<script src="/Scripts/FixTable.js" type="text/javascript"></script>
<script src="/Scripts/DatePicker/WdatePicker.js" type="text/javascript"></script>
<script src="/Scripts/OrderModule/PlatformChangeApplyform.js?20130301" type="text/javascript"></script>