<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PostponeApplyformDetail.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.OrderModule.Operate.PostponeApplyformDetail" %>
...
<body>
    ...
    <div class="colus form">
        <table>
            ...
            <tr>
                <td class="title">采购方</td>
                <td><a runat="server" id="linkPurchaser" class="obvious-a"></a></td>
                <td class="title">出票方</td>
                <td><a runat="server" id="linkProvider" class="obvious-a"></a></td>
            ...
            <tr>
                ...
                <td colspan="5"><asp:Label runat="server" ID="lblAppliedReason"></asp:Label></td>
            </tr>
            <tr>
    ...
    <div class="btns">
        <button runat="server" id="btnProcess" class="btn class1" visible="false">处&nbsp;&nbsp;&nbsp;&nbsp;理</button>
