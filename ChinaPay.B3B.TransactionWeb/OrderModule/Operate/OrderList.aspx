<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderList.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.OrderModule.Operate.OrderList"
...
<body>
        ...
        <div class="orderCondition clearfix">
            ...
            <div class="col">
                <span><b>航空公司：</b>
                    ...
                    <input type="checkbox" checked="checked" id="chkProffession" runat="server" value="1" />
                    <label for="chkProffession">
                        同行</label>
                    <input type="checkbox" id="chkSubordinate" runat="server" value="2" />
                    <label for="chkSubordinate">
                        下级</label>
                    <input type="checkbox" id="chkInterior" runat="server" value="4" />
                    <label for="chkInterior">
                        内部机构</label>
                </span>
            </div>
            <div class="col">
                <span>
                    ...
                    <div style="z-index: 2;" class="uc">
                        <b class="name">产品方：</b><uc:Company runat="server" ID="ucSupplier" />
                    </div>
                </span><span>
                    <div style="z-index: 1;" class="uc">
                        <b class="name">出票方：</b><uc:Company runat="server" ID="ucProvider" />
                    </div>
                </span><span>
                    <input type="button" value="查询" id="btnSerach" class="btn class1" /></span>
            </div>
        </div>
    ...
    <div class="tips_box_left hidden" id="divOem">
        <div class="tips_bd">
            <p>
                该订单来源于OEM版本，请酌情处理</p>
        </div>
    </div>
    <div class="tips_box_left hidden" id="divAllowPlatformContractPurchaser">
        <div class="tips_bd">
            <p>
                该OEM用户不允许平台直接联系采购，请与OEM用户联系让其自行处理</p>
        </div>
    </div>
    </form>
</body>
...
<script src="/Scripts/OrderModule/Operate/OrderList.aspx.js?20130407" type="text/javascript"></script>
