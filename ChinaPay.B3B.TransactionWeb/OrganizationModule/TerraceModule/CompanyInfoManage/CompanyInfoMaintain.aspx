<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CompanyInfoMaintain.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.OrganizationModule.TerraceModule.CompanyInfoManage.CompanyInfoMaintain" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>企业管理基本信息维护</title>
...
<body>
    <div class="form">
        ...
        <table>
            ...
            <tbody runat="server" id="fixedPhone" visible="false">
                <tr>
                    <td class="title">
                        固定电话：
                    </td>
