<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegisterBuy.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.OrganizationModule.RoleModule.ExtendCompanyManage.RegisterPage.RegisterBuy" %>
    ...
    <div class="form">
        ...
        <table>
            ...
            <tr class="btns">
                ...
                <td>
                    <asp:Button ID="btnSubmit" runat="server" Text="完成开户" CssClass="btn class1" OnClick="btnSubmit_Click" />
                </td>
            </tr>
        </table>
