<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeSpreadStatisticReport.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.ReportModule.EmployeeSpreadStatisticReport" %>
...
<body>
    ...
    <asp:HiddenField runat="server" ID="txtEmpolyeeNo"/>
    </form>
</body>
</html>
