<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseErrorRefundReport.aspx.cs" Inherits="ChinaPay.B3B.TransactionWeb.ReportModule.PurchaseErrorRefundReport" %>
...
<body>
   <form id="query" runat="server">
    <h3 class="titleBg">
        差错退款统计（温馨提示：当日报表数据可于下午18：00后（或20：00、22：00）进行下载，当日全部数据需在次日进行下载。）</h3>
    <div class="box-a">
        <div class="condition">
            <table>
                <colgroup>
        ...
        <asp:Repeater runat="server" ID="dataList" EnableViewState="false">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
                       <%#Eval("PurchaserBillSuccess")%>
                    </td>
                    <td>
                        <%#Eval("ApplierAccountName")%>
                    </td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
    ...
    <asp:HiddenField ID="hfdPurchase" runat="server" />
    </form>
</body>
</html>
...
<script src="../Scripts/Report/PurchaseErrorRefundReport.js?20130521" type="text/javascript"></script>