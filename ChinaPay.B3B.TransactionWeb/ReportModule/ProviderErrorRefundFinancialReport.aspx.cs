...
{
    public partial class ProviderErrorRefundFinancialReport : BasePage
    {
        ...
        private void queryErrorRefund(Pagination pagination)
        {
            try
            {
                var dataSource = ReportService.QueryProviderErrorRefundFinancial(pagination, getCondition());
        ...
        private DataTransferObject.Report.ErrorRefundQueryCondition getCondition()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.ddlOperator.SelectedValue))
                condition.ProcessAccount = this.ddlOperator.SelectedValue;
            condition.Provider = this.CurrentCompany.CompanyId;
            return condition;
        }
        ...
        {
            this.hfdProvider.Value = this.CurrentCompany.CompanyId.ToString();
