<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseTicketReport.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.ReportModule.PurchaseTicketReport" %>
...
<body>
    ...
    <h3 class="titleBg">
        买入机票明细（温馨提示：当日报表数据可于下午18：00后（或20：00、22：00）进行下载，当日全部数据需在次日进行下载。）</h3>
    <div class="box-a">
        <div class="condition">
            <table>
                <colgroup>
                ...
                <tr>
                    <td>
                        <div class="input">
                            <span class="name">PNR：</span><asp:TextBox runat="server" ID="txtPNR" class="text textarea"
                ...
                <tbody id="seniorCondition" runat="server">
                    <tr>
                        ...
                        <td>
                            <div class="input">
                                <span class="name resetName">乘机人：</span><asp:TextBox runat="server" ID="txtPassenger"
...
<script src="../Scripts/Report/PurchaseTicketReport.js?20130225" type="text/javascript"></script>
<script src="../Scripts/Report/Scroll.js?20130226" type="text/javascript"></script>
