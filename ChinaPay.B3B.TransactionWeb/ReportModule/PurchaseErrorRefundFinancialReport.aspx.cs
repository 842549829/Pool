...
{
    public partial class PurchaseErrorRefundFinancialReport : BasePage
    {
        ...
        private void queryErrorRefund(Pagination pagination)
        {
            try
            {
                var dataSource = ReportService.QueryPurchaseErrorRefundFinancial(pagination, getCondition());
