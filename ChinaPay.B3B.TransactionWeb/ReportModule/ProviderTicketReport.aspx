<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProviderTicketReport.aspx.cs"
    Inherits="ChinaPay.B3B.TransactionWeb.ReportModule.ProviderTicketReport" %>
...
<body>
    ...
    <h3 class="titleBg">
        卖出机票明细（温馨提示：当日报表数据可于下午18：00后（或20：00、22：00）进行下载，当日全部数据需在次日进行下载。）</h3>
    <div class="box-a">
        <div class="condition">
            <table>
                <colgroup>
                    ...
                    <tr>
                        <td>
                            <div class="input">
                                ...
                                <asp:TextBox runat="server" ID="txtTakeOffLower" class="text text-s1 reset" onfocus=" WdatePicker({ skin: 'default', isShowClear: false, maxDate: '#F{$dp.$D(\'txtTakeOffUpper\')||\'2020-10-01\'}' })">
                                </asp:TextBox>
                                <span class="resetName"> -</span>
                                <asp:TextBox runat="server" ID="txtTakeOffUpper" class="text text-s1 reset" onfocus="WdatePicker({ skin: 'default', isShowClear: false, minDate: '#F{$dp.$D(\'txtTakeOffLower\')}', maxDate: '2020-10-01' })">
                                </asp:TextBox>
                            </div>
                        </td>
                        <td>
...
<script src="../Scripts/Report/ProviderTicketReport.js?20130225" type="text/javascript"></script>
