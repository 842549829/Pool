...
function openLayer(objId, conId) {
    ...
    if (!document.getElementById("popupAddr")) {
        ...
        popupDiv.style.border = "2px solid #ff8b1a";
    ...
    document.getElementById("bodybg").innerHTML = "";
    document.getElementById("popupAddr").innerHTML = "";
    //显示内容层
    var popObj = document.getElementById("popupAddr")
    popObj.innerHTML = document.getElementById(conId).innerHTML;
    document.getElementById(conId).innerHTML = ""; //赋值后立即清除原HTML代码
