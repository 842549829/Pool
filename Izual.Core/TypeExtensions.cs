...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Core.TypeExtensions.cs
// description：
// 
// create by：Izual ,2012/06/17
...
namespace Izual {
    ...
    public static class TypeExtensions {
        ...
        /// <summary>
        /// k 获取序列类型中的元素类型（例如：对于类型 IEnumerable&lt;T&gt;，GetTypeOfElements 方法将返回类型 T）
        /// </summary>
        /// <param name="seqType"> </param>
        /// <returns> </returns>
        ...
        public static bool IsSimpleType(this Type type) {
            if (type.IsEnum || type == typeof(Time) || type == typeof(Time2) || type == typeof(Guid))
                return true;
