...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Data.DbExpressionWriter.cs
// description：
// 
...
namespace Izual.Data.Common {
    ...
    public class DbExpressionWriter : ExpressionWriter {
        ...
        protected virtual Expression VisitColumn(ColumnExpression column) {
            int iAlias;
            string aliasName = aliasMap.TryGetValue(column.Alias, out iAlias) ? "A" + iAlias : "A" + (column.Alias != null ? column.Alias.GetHashCode().ToString() : "") + "?";
