...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Data.DbExpressionComparer.cs
// description：
// 
    ...
    public class DbExpressionComparer : ExpressionComparer {
        ...
        protected override bool Compare(Expression a, Expression b) {
            ...
            switch((DbExpressionType)a.NodeType) {
                ...
                case DbExpressionType.Entity:
                    return CompareEntity((EntryExpression)a, (EntryExpression)b);
        ...
        protected virtual bool CompareSelect(SelectExpression a, SelectExpression b) {
            ...
            try {
                ...
                return Compare(a.Where, b.Where) && CompareOrderList(a.OrderBy, b.OrderBy) && CompareExpressionList(a.GroupBy, b.GroupBy) && Compare(a.Skip, b.Skip) && Compare(a.Take, b.Take) &&
                       a.IsDistinct == b.IsDistinct && a.IsReverse == b.IsReverse && CompareColumnDeclarations(a.Columns, b.Columns);
            }
            finally {
                aliasScope = save;
            }
        ...
        protected virtual bool CompareProjection(ProjectionExpression a, ProjectionExpression b) {
            ...
            try {
                ...
                return Compare(a.Projector, b.Projector) && Compare(a.Aggregator, b.Aggregator) && a.IsSingleton == b.IsSingleton;
            }
            finally {
                aliasScope = save;
            }
