...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Data.RedundantSubqueryRemover.cs
// description：
// 
    ...
    public class RedundantSubqueryRemover : DbExpressionVisitor {
        ...
        private class RedundantSubqueryGatherer : DbExpressionVisitor {
            ...
            private static bool IsRedudantSubquery(SelectExpression select) {
                return (IsSimpleProjection(select) || IsNameMapProjection(select)) && !select.IsDistinct && !select.IsReverse && select.Take == null && select.Skip == null && select.Where == null &&
        ...
        #region Nested type: SubqueryMerger
        ...
        private class SubqueryMerger : DbExpressionVisitor {
            ...
            private static bool CanMergeWithFrom(SelectExpression select, bool isTopLevel) {
                ...
                if(fromSelect.IsDistinct &&
                   (select.Take != null || select.Skip != null || !selHasNameMapProjection || selHasGroupBy || selHasAggregates || (selHasOrderBy && !isTopLevel) || selHasJoin))
                    return false;
