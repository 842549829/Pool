...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Data.DbTypeSystem.cs
// description：
// 
...
namespace Izual.Data {
    public class DbTypeResolver : QueryTypeResolver {
        ...
        public override QueryType Parse(string typeDeclaration) {
            ...
            bool isNotNull = (remainder != null) && remainder.ToUpper().Contains("NOT NULL");
        ...
        public override QueryType GetColumnType(Type type) {
            ...
            switch(Type.GetTypeCode(type)) {
                ...
                default:
                    if (type == typeof(Time) || type == typeof(Time2))
                        return NewType(SqlDbType.Time, isNotNull, 0, 0, 0);
                    if (type == typeof(object))
                        return NewType(SqlDbType.Variant, isNotNull, 0, 0, 0);
                    if(type == typeof(byte[]))
    ...
    public class DbQueryType : QueryType {
        ...
        public DbType DbType {
            get { return DbTypeResolver.GetDbType(dbType); }
        }
