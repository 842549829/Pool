...
// ////////////////////////////////////////////////////////////////////////////////////////////////
// file：Izual.Linq.ExpressionWriter.cs
// description：
// 
    ...
    public class ExpressionWriter : ExpressionVisitor {
        ...
        protected override Expression VisitConstant(ConstantExpression c) {
            if(c.Value == null) {
                ...
                VisitNewArray(Expression.NewArrayInit(elementType, ((IEnumerable)c.Value).OfType<object>().Select(v => (Expression)Expression.Constant(v, elementType))));
            }
            else {
                Write(c.Value.ToString());
            }
