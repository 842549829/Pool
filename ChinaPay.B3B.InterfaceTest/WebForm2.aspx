<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm2.aspx.cs" Inherits="ChinaPay.B3B.InterfaceTest.WebForm2"
...
<body>
    ...
    <div>
        <div>
            ...
            <asp:Button runat="server" ID="btnManualPay" Text="手动支付" 
                onclick="btnManualPay_Click" />
        </div>
        <div>
            <asp:Panel ID="PNRImportNoNeedPat" runat="server" Visible="false">
                <b>政策导入(PNRImportNoNeedPat)：</b><br />
                编码信息(pnrContext):<asp:TextBox ID="pnrContext3" Columns="30" Rows="30" runat="server"
                    TextMode="MultiLine" Height="300px" Width="100%"></asp:TextBox>
                <br />
                <br />
            </asp:Panel>
            <asp:Panel ID="PNRImport" runat="server">
                ...
                编码信息(pnrContext):<asp:TextBox ID="pnrContext" Columns="30" Rows="30" runat="server"
                    TextMode="MultiLine" Height="300px" Width="100%"></asp:TextBox><br />
                <br />
                PAT信息(patContext):<asp:TextBox ID="patContext" Columns="30" Rows="30" runat="server"
                    TextMode="MultiLine" Height="300px" Width="100%"></asp:TextBox>
                <br />
                <br />
            </asp:Panel>
            <asp:Panel ID="ProduceOrder" runat="server" Visible="false">
                ...
                编码信息(pnrContext):<asp:TextBox ID="pnrContext1" CssClass="context" TextMode="MultiLine"
                    Height="300px" Columns="30" Rows="30" Width="100%" runat="server"></asp:TextBox><br />
                <br />
                PAT信息(patContext):<asp:TextBox ID="patContext1" Columns="30" Rows="30" runat="server"
                    TextMode="MultiLine" Height="300px" Width="100%"></asp:TextBox>
                <br />
                <br />
            ...
            <asp:Panel ID="ManualPay" runat="server" Visible="false">
                <b>手动支付(ManualPay)：</b><br />
                订单号(id):<asp:TextBox ID="txtId" runat="server"></asp:TextBox><br />
                <br />
                支付方式(payType):<asp:TextBox ID="txtPayType5" runat="server"></asp:TextBox><br />
                <br />
                业务类型(businessType):<asp:TextBox ID="txtBusinessType" runat="server"></asp:TextBox><br />
                <br />
            </asp:Panel>
